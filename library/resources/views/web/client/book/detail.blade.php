@extends('web.client.layouts.master')
...
@section('content')
    ...
    <div class="container xl:max-w-[1200px] xl:px-0 max-w-full px-10 lg:py-10 md:py-10 py-5 mx-auto">


        <div class="my-5">

            <figure class="max-w-screen-md mx-auto text-center pb-10">
                ...
                <blockquote>
                    <p class="text-2xl italic font-medium text-gray-900 dark:text-white">"The more that you read, the more
                        things you will know. The more that you learn, the more places you'll go."</p>
                </blockquote>
            </figure>
        ...
        <div class="flex gap-5 relative">
            ...
            <div class="sticky top-0">
                <div
                    class="sticky top-0 w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="w-full">
                ...
                <form class="w-full sticky top-0 z-50 mb-5 shadow">
                    <div class="flex">
                ...
                {{-- <div class="w-full grid grid-cols-4 aos-list  gap-4 p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700"> --}}
                <div class="w-full grid aos-list p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex gap-5">

                        <div>
                            <img loading="lazy" class="min-w-[100px] max-w-[200px] w-25"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQggF1zGeroM103pWJpi5_gEkOvgXzJw-2PVks9sr73PN-HYwI-WvSjwaHifclWWg_jn4I&usqp=CAU"
                                alt="">
                        </div>

                        <div style="align-content: space-between ; display: flex; flex-wrap: wrap"  >
                            <div class="w-full">
                                <h1 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Book Name</h1>
                                <h3 class="text-lg">Author : <strong>Author's Name</strong></h3>
                                <h3 class="text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel voluptates eum tenetur, eveniet repellat corrupti iure quas accusantium, ipsam alias deserunt. Neque, facere molestias voluptatibus nobis blanditiis error nihil eaque?</h3>
                            </div>

                            <div class="mt-5 w-full">
                                <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">donwload</button>
                                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Read Now</button>
                            </div>
                    ...
                    {{-- other books  --}}
                    <div class="my-10">
                        <h2 class="text-lg my-2">You may like these books</h2>
                        <div class="w-full grid grid-cols-6 aos-list  gap-4 ">
