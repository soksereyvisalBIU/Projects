    ...
    <div class="container xl:max-w-[1200px] xl:px-0 max-w-full px-10 lg:py-10 md:py-10 py-5 mx-auto">
        ...
        <div class="my-10">
            ...
            <figure class="max-w-screen-md mx-auto text-center pb-10">
                ...
                <blockquote>
                    <p class="text-2xl italic font-medium text-gray-900 dark:text-white">"The more that you read, the more things you will know. The more that you learn, the more places you'll go."</p>
                </blockquote>
            </figure>
        ...
        <div class="flex gap-5 relative">
            ...
            <div>
                ...
                <div
                    class="w-full grid grid-cols-4 aos-list  gap-4 p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <article data-aos="fade-up">
                        <a href="" class="relative overflow-hidden group ">
                            <div class="">
                                <img loading="lazy" class="w-full"
                                    src="https://content.wepik.com/statics/90897927/preview-page0.jpg" alt="">
                            </div>
                            <div class="absolute bottom-0 p-2 bg-gradient-to-t from-slate-900 h-[100%] w-[100%]">
                                <div class="ralative">
                                    <div class="absolute bottom-2">
